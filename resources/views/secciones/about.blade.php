...
<body>
  ...
  <div class="row">
    <div class="column">
      <div class="card">
        <img src="./samuel.png" alt="Jane" style="width:100%">
        <div class="container">
          <h2>Samuel Perez</h2>
    ...
    <div class="column">
      <div class="card">
        <img src="./Gerald.png" alt="Mike" style="width:100%">
        <div class="container">
    ...
    <div class="column">
      <div class="card">
        <img src=".\schiffman.png" alt="John" style="width:100%">
        <div class="container">
    ...
    <div class="column">
      <div class="card">
        <img src=".\Kenny.png" alt="John" style="width:100%">
        <div class="container">
          <h2>Keny Lopez</h2>
    ...
    <div class="column">
      <div class="card">
        <img src="./Emmanuel.png" alt="John" style="width:100%">
        <div class="container">
